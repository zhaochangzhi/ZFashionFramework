 ...
 * Spring example:
 * 
 * <bean id="jedisConfig" class="org.dyframework.commonRedis.client.jedis.JedisPoolConfig"> <property
 * name="testWhileIdle" value="true"/> </bean>
 * 
 * <bean id="jedisPool" class="org.dyframework.commonRedis.client.jedis.JedisPool"
...
public class JedisPoolConfig extends Config {
	...
	public String keyvale;
    public String getKeyvale() {
		return keyvale;
	}

	public void setKeyvale(String keyvale) {
		this.keyvale = keyvale;
	}
